                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <%
                            ...
                            if (student == null) {
                        %>
                            <div class="alert alert-danger mt-4">未找到该学生信息，请返回列表重试。</div>
                        <%
                            } else {
                        %>
                        <form action="<%= request.getContextPath() %>/student/update" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="age" name="age" value="<%= student.getAge() %>" required min="1" max="100">
                            </div>
                            <div class="mb-3">
